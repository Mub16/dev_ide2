    ...
    for ($step = 0; $step < $start; $step++) {
        ...
        echo ("
            <tr>
              ...
              <td> $INN </td>
              <td> $Sertificate </td>
              <td><form name='bd_edi' method='post' action='document=editor'><button name = 'Edit' value='$step'>Edit</button></form>
                  <form name='bd_del' method='post' action='document=delete'><button name = 'Delete' value='$step'>Delete</button></form></td>
            </tr>
            ");
    }
}
