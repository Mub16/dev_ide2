<?php
require_once("fnction/local_functions.php");//Ошибка Fatal error: require_once(): Failed opening required 'include_path=Set_Document/local/local_functions.php' (include_path='.:/usr/local/lib/php') in /var/www/Set_Document/delete.php on line 2
